...
// *********************************************************************
// Function that creates the circle earthquake magnitude markers
//      ** Change the values of these options to change the circle size 
...
function circleMarker(feature, latlng ){
  ...
  for (var i = 0; i < earthquakes.length; i++) {
    L.circle(earthquakes[i].geometry.coordinates, {
      ...
      fillColor: magnitudeColors(feature.properties.mag), 
      radius: markerSize(feature.properties.mag),
    }).bindPopup("<h1>" + earthquakes[i].name + "</h1> <hr> <h3>Population: " + 
                          earthquakes[i].population + "</h3>")
    .addTo(myMap);
  }
